...
/*
	TODO:
		- SPLIT BUILDING OF OBJECTS IN BUILDER OBJECTS NOT INTERNAL FUNCTIONS: PHYSICS BODY, PHYSICS JOINT,
		  SOLID BODY AGENT, AI AGENT... 
*/
...
class MMGame;  //Main game logic container class
...
public:
	...
	LevelBuilder(MMGame* thegamelogic):
...
protected:
	...
	MMGame* mGameLogicptr;    //Pointer to game logic
	...
	void _processBodyChainEntity(ticpp::Iterator<ticpp::Element> theentity, const std::string& filepath);
